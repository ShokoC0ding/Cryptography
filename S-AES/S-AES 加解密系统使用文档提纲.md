...
加密结果为: ['1100111000010010', '0110111000010111', '0100111000010101']
 ...
 <img src="..\S-AES\S_AES照片\2.3(1).jpg" style="zoom: 67%;" />

- 对应解密演示

<img src="..\S-AES\S_AES照片\2.3(2).jpg" style="zoom: 67%;" />
...
<img src="..\S-AES\S_AES照片\2.4(1).jpg" style="zoom: 67%;" />

所得密文为：1101000000010011

解密演示：

<img src="..\S-AES\S_AES照片\2.4(2).jpg" style="zoom: 67%;" />
...
<img src="..\S-AES\S_AES照片\2.4(3).jpg" style="zoom: 67%;" />
...
<img src="..\S-AES\S_AES照片\2.4(6).jpg" style="zoom: 67%;" />

得到密文：1010000110001111

再进行解密演示：

<img src="..\S-AES\S_AES照片\2.4(7).jpg" style="zoom: 67%;" />
...
<img src="..\S-AES\S_AES照片\2.5(1).jpg" style="zoom: 67%;" />

得到密文：0110100111001001,1110111001110101,0101100010011000,0100101010001001

解密演示：

<img src="..\S-AES\S_AES照片\2.5(2).jpg" style="zoom: 67%;" />

成功得到原来的密文，加解密成功

接着调转密文块的分组顺序，下面演示篡改密文后的解密结果：

<img src="..\S-AES\S_AES照片\2.5(3).jpg" style="zoom: 67%;" />
...
<img src="..\S-AES\S_AES照片\3.1.1.jpg" style="zoom: 67%;" />
...
<img src="..\S-AES\S_AES照片\3.1.3(1).jpg" style="zoom: 67%;" />

<img src="..\S-AES\S_AES照片\3.1.3(2).jpg" style="zoom: 67%;" />
...
<img src="..\S-AES\S_AES照片\3.1.4(1).jpg" style="zoom: 67%;" />

<img src="..\S-AES\S_AES照片\3.1.4(2).jpg" style="zoom: 67%;" />

·    **CBC模式操作**
 CBC（密码分组链接）模式通过在每一加密轮中对明文块进行异或处理，进一步提升了数据的随机性和安全性。系统会要求用户输入一个初始向量（IV），并将其与密钥一起用于加解密操作。CBC 模式能够有效防止密文模式的重复，从而增强安全性。

<img src="..\S-AES\S_AES照片\3.1.4(3).jpg" style="zoom: 67%;" />
